 ...
 * Credit: http://mike.seddon.ca/a-better-binarizer-for-apache-spark-ml/
 */
@Experimental
final class Binarizer2(override val uid: String)
  ...
  override def copy(extra: ParamMap): Binarizer2 = defaultCopy(extra)
}

@Since("1.6.0")
object Binarizer2 extends DefaultParamsReadable[Binarizer2] {

  @Since("1.6.0")
  override def load(path: String): Binarizer2 = super.load(path)
}